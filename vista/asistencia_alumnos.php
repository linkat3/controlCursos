...
<div class="p-4 mb-3 bg-light rounded-3">
    <div class="container-fluid py-2">
        ...
        <h2>Elige a la materia que quieres pasar asistencia</h2>

        <div>
            <?php foreach ($materias as $materia) { ?>
                <div hidden><?php echo $materia['codigo']; ?></div>
                <p class="p-2" id="materia">
                    <a href="./consulta_materia_asistencia.php?id=<?php echo $materia["codigo"] ?>" class="btn btn-warning"><?php echo $materia['nombre']; ?></a>
